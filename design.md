...
Type uses **Noto Sans** throughout: weight 300 for display and 400/500 for body, navigation, captions, and buttons. The display weight at 300 is the editorial signature — never bold, never heavy.
...
- Display runs Noto Sans at weight 300 — preserving the light, editorial voice.

- Body runs Noto Sans at 400 with subtle letter-spacing (+0.15-0.18px).
...
Noto Sans is the primary typeface throughout the system. Display uses weight 300, while body, navigation, captions, and buttons use weights 400/500. Fallback: sans-serif.
...
| {typography.title-md} | 20px | 500 | 1.35 | 0 | Component titles — Noto Sans |

| `{typography.title-sm}` | 18px | 500 | 1.44 | 0.18px | List labels |

| {typography.body-md} | 16px | 400 | 1.5 | 0.16px | Default body — Noto Sans |
...
- Display weight stays at 300. Noto Sans at weight 300 provides the light display treatment. Never bold display copy.

- Subtle letter-spacing on body. Noto Sans at +0.15-0.18px tracking — slightly looser than default for a more editorial feel.

- Negative letter-spacing on display. Noto Sans uses -0.32px to -1.92px tighter tracking on display sizes.

### Note on Font Substitutes

Noto Sans is the primary typeface for both display and body. Use sans-serif as the fallback. No separate display serif substitute is required.
...
`button-primary` — Near-black ink pill. Background {colors.primary}, text {colors.on-primary}, type {typography.button} (15px / 500 Noto Sans), padding 10px × 20px, height 40px, rounded {rounded.pill}.
...
`hero-band` — Background {colors.canvas}, full-width Noto Sans display headline in {typography.display-mega} (64px / 300 / -1.92px), subhead in {typography.body-md}, two CTAs, and an atmospheric gradient orb behind the centered headline.
...
- Use Noto Sans at weight 300 for every display headline. Never bold.

- Use Noto Sans at +0.15-0.18px tracking for body — the editorial dialect.
...
- Don't drop body Noto Sans to weight 300 to match the display treatment — body stays at 400/500 for legibility.
...
6. Noto Sans 300 for display, Noto Sans 400/500 for body.

7. Gradient orbs scoped to atmospheric decoration.

## Known Gaps

- Noto Sans is the primary typeface for both display and body; sans-serif is the fallback.
